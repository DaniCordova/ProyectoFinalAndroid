...
public class CharacterAdapter extends RecyclerView.Adapter<CharacterAdapter.CharacterViewHolder> {
    ...
    static class CharacterViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ResultCharacter.Result result){
            ...
            TextView textViewName, textViewGender, textViewStatus, textViewSpecies, textViewType, textViewLocation, textViewEpisode;
            ...
            textViewEpisode = itemView.findViewById(R.id.textView_episode);
            ...
            textViewEpisode.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View v){
